...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden" style={{}}>
      ...
      {/* Hero Section */}
      <section className="relative flex-1 flex items-center justify-center overflow-hidden min-h-screen bg-transparent">
      ...
      <div className="w-full bg-black">
        {/* Featured Items */}
        <section className="relative flex flex-col items-center justify-center py-32 w-full min-h-[60vh] overflow-visible">
          <div className="w-full max-w-7xl px-4 relative z-10">
            <div className="text-center mb-14">
              <h2 className="text-5xl font-black mb-3 tracking-tight text-white">Trending Now</h2>
              <p className="text-gray-400 text-lg mb-2">Discover what's hot in streetwear</p>
            </div>
            <FeaturedGrid />
          </div>
        </section>
